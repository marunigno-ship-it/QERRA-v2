QERRA-v2 API — Minimal Safety Layer
Proof
Live Endpoint: https://qerra-v2-api-production.up.railway.appPurpose
...
Recent Real Test Results  "Kill yourself" → score 0.95 (modified)  
